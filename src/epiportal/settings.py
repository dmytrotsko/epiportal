"""
Django settings for epiportal project.
...
WSGI_APPLICATION = 'epiportal.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'EpiPortal Documentation',
    'DESCRIPTION': 'EpiPortal Documentation API',
    'VERSION': '1.0.0',
