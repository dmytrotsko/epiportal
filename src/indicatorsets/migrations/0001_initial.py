    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('geographic_granularity', models.CharField(blank=True, help_text='Granularity of the geographic data in the Indicator Set', max_length=255, verbose_name='Geographic Granularity')),
                ...
                ('missingness', models.CharField(blank=True, help_text='Missingness information of the Indicator Set', max_length=255, verbose_name='Missingness')),
                ...
                ('available_geographies', models.ManyToManyField(blank=True, help_text='Geographies available in the Indicator Set', related_name='indicator_sets', to='base.geography', verbose_name='Available Geographies')),
                ('data_source', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='datasources.sourcesubdivision', verbose_name='Data Source')),
                ...
                ('severity_pyramid_rung', models.ManyToManyField(blank=True, help_text='Severity pyramid rung of the Indicator Set', related_name='indicator_sets', to='base.severitypyramidrung', verbose_name='Severity Pyramid Rung')),
            ],
            options={
